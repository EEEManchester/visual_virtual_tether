...
from visual_virtual_tether.cfg import MallardTwistConfig
...
class mallard_to_twist:
    ...
    def initialise_reconf_server(self):
        ...
        self.reconf_server = Server(MallardTwistConfig, self.reconfigure_callback)
        self.reconf_client = Client('mallard_to_twist')
        self.reconf_client.update_configuration({
            "gain_x": rospy.get_param('mallard_to_twist/overall_gain/x', 1),
            "gain_y": rospy.get_param('mallard_to_twist/overall_gain/y', 0.8),
            "gain_yaw": rospy.get_param('mallard_to_twist/overall_gain/yaw', 0.5),
            "joy_gain_x": rospy.get_param('mallard_to_twist/joy_gain/x', 1),
            "joy_gain_y": rospy.get_param('mallard_to_twist/joy_gain/y', 0.8),
            "joy_gain_yaw": rospy.get_param('mallard_to_twist/joy_gain/yaw', 0.5),
            "vt_gain_x": rospy.get_param('mallard_to_twist/virtual_tether_gain/x', 1),
            "vt_gain_y": rospy.get_param('mallard_to_twist/virtual_tether_gain/y', 0.8),
            "vt_gain_yaw": rospy.get_param('mallard_to_twist/virtual_tether_gain/yaw', 0.5)
        })
